...
class Subject(db.Model):
    ...
    start_time = db.Column(db.String(20), default="00:00")
    end_time = db.Column(db.String(20), default="23:59")
...
def add_subject():
    ...
    if name and exam_timer and start_time and end_time:
        try:
...
def update_subject(subject_id):
    ...
    if name and exam_timer and start_time and end_time:
        try:
            ...
            # update linked questions if subject name changes
            linked_questions = Question.query.filter_by(subject=old_name).all()
...
def import_excel():
    ...
    if request.method == "POST":
        ...
        if excel_file and selected_subject:
            ...
            # columns:
            # A = question, B = opt1, C = opt2, D = opt3, E = opt4, F = answer
